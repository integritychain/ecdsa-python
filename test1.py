...
z = ecdsa.multiply_k_p(0xc9806898a0334916c860748880a541f093b579a9b1f32934d86c363c39800357, g)
...
z = ecdsa.multiply_k_p(0x710735c8388f48c684a97bd66751cc5f5a122d6b9a96a2dbe73662f78217446d, g)
...
z = ecdsa.multiply_k_p(0x78d5d8b7b3e2c16b3e37e7e63becd8ceff61e2ce618757f514620ada8a11f6e4, g)
...
z = ecdsa.multiply_k_p(0x2a61a0703860585fe17420c244e1de5a6ac8c25146b208ef88ad51ae34c8cb8c, g)
...
z = ecdsa.multiply_k_p(0x01b965b45ff386f28c121c077f1d7b2710acc6b0cb58d8662d549391dcf5a883, g)
...
z = ecdsa.multiply_k_p(0xfac92c13d374c53a085376fe4101618e1e181b5a63816a84a0648f3bdc24e519, g)
...
z = ecdsa.multiply_k_p(0xf257a192dde44227b3568008ff73bcf599a5c45b32ab523b5b21ca582fef5a0a, g)
...
z = ecdsa.multiply_k_p(0xadd67e57c42a3d28708f0235eb86885a4ea68e0d8cfd76eb46134c596522abfd, g)
...
z = ecdsa.multiply_k_p(0x4494860fd2c805c5c0d277e58f802cff6d731f76314eb1554142a637a9bc5538, g)
...
z = ecdsa.multiply_k_p(0xd40b07b1ea7b86d4709ef9dc634c61229feb71abd63dc7fc85ef46711a87b210, g)
...
r = ecdsa.multiply_k_p(k.coord, CurveP256.GENERATOR).x.coord % CurveP256.ORDER
print("My r: ", r)
...
vA = ecdsa.multiply_k_p(u1, CurveP256.GENERATOR)
vB = ecdsa.multiply_k_p(u2, keyPair.public)
