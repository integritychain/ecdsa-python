        ...
        for index, line in enumerate(file):
            ...
            if len(items) > 1:
                ...
                if items[0] == 'S' and PGO == 1:
                    ...
                    r, s = ecdsa.sign(params['Msg'], key_pair.private, k=int.from_bytes(params['k'], byteorder='big'))
        ...
        for index, line in enumerate(file):
            ...
            if len(items) > 1:
                ...
                if items[0] == 'Result' and PGO == 1:
                    ...
                    if items[0].startswith("Result = T") and res != True: raise RuntimeError("CAVP Pass, Code Fail")
                    if items[0].startswith("Result = F") and res != False: raise RuntimeError("CAVP Fail, Code Pass")
                    print("PASS")
